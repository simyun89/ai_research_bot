...
- 분석 공통 규칙
  - 각 기회마다 **Impact(영향)** / **Feasibility(실현가능성)** / **Time-to-Value(단기·중기·장기)** 를 3단계(높음·중간·낮음)로 평가해 표기.
...
- **① 인수·투자 기회**
  - 기사 속 대상 회사·기술의 “Strategic Fit(시너지 영역)” + “Risk 요인”까지 서술.
  - 최대 5 개.
- **② 신사업 기회**
  - '대중교통', '결제·정산'과 같이 접점이 큰 **서비스 구조**를 그림 없이 텍스트로 간단히 개념화.
  - TAM·SAM·SOM 추정치가 있으면 적용.
  - 새로운 사업 아이디어 또는 확장 가능한 영역 도출
- **③ 전략적 제휴 기회**
  • 파트너사 제안 시 **협업 모델(공동 개발·데이터 교환·리셀링 등)을 명시**하고, Win-Win 논리를 1문단 이상
